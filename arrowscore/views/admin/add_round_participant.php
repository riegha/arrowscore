<?php ob_start(); ?>
<h2 class="text-xl font-bold mb-4">Tambah Peserta ke Babak - <?= htmlspecialchars($round['name']) ?></h2>
...
<?= CSRF::getTokenField() ?>
    ...
    <div class="flex gap-2">
        ...
        <a href="<?= BASE_URL ?>/admin/round-participants/<?= $round_id ?>" class="bg-gray-300 text-gray-700 px-4 py-2 rounded">Batal</a>
    </div>
</form>
