<?php ob_start(); ?>
<h2 class="text-xl font-bold mb-4">Edit Peserta - <?= htmlspecialchars($participant['name']) ?></h2>
...
<form method="post" class="bg-white p-4 rounded shadow space-y-3 max-w-lg">
    ...
    <div class="flex gap-2">
        ...
        <a href="<?= BASE_URL ?>/admin/participants/<?= $competition_id ?? '' ?>" class="bg-gray-300 text-gray-700 px-4 py-2 rounded">Batal</a>
    </div>
</form>
